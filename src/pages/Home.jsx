  ...
  return (
    <section ref={heroRef}
      ...
      <div className="absolute pointer-events-none"
        style={{
          width: 1000, height: 720, top: '-12%', right: '-18%',
      ...
      <div className="absolute pointer-events-none float-3"
        style={{
          width: 520, height: 420, bottom: '-6%', left: '-6%',
      ...
      <div className="absolute pointer-events-none float-2"
        style={{
          width: 600, height: 500, top: '35%', right: '20%',
        ...
        <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {CAPS.map((c, i) => (
            <div key={i}
              ...
              style={{
                padding: '28px', borderRadius: 'var(--r-xl)', background: 'rgba(255,255,255,0.035)',
